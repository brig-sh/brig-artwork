# brig-artwork AI Policy

AI-assisted development is welcome in brig-artwork.
...
A contribution is judged as a contribution to brig-artwork, not as AI output.
...
## AI does not relax brig-artwork's engineering rules
...
brig-artwork may be developed using interactive assistants as well as autonomous or unattended agents.
...
We welcome research involving brig-artwork and AI-assisted software engineering, including:
...
If an experiment produces a genuinely useful improvement to brig-artwork, we welcome it as a contribution.
